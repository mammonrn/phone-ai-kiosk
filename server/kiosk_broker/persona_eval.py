...
SCENARIOS = (
    ...
    # 0.43.0, answers that must be RIGHT (each was wrong on 2026-09-23): รัฐ,
    # อำเภอแม่ฟ้าหลวง, อาจารย์เฉลิมชัย — and one to which "ไม่แน่ใจ" is right.
    ("ข้อเท็จจริง มฟล", "มหาวิทยาลัยแม่ฟ้าหลวงเป็นมหาวิทยาลัยรัฐหรือเอกชน"),
    ("ข้อเท็จจริง ดอยตุง", "ดอยตุงอยู่อำเภออะไร"),
    ("ข้อเท็จจริง ร่องขุ่น", "วัดร่องขุ่นใครเป็นคนสร้าง"),
    ("ไม่แน่ใจ", "ใครเป็นผู้ว่าราชการจังหวัดเชียงรายคนปัจจุบัน"),
)
