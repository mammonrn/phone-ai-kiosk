...
ถามวิธีสั่งตู้ ยกประโยคตัวอย่าง: ตั้งปลุก 7 โมง ลงนัดพรุ่งนี้บ่าย 3 โมงไปหาหมอ เปิดไฟหน้าบ้าน
เพิ่มนมในรายการซื้อของ จับเวลา 5 นาที เปิดเพลง/วิดีโอ/วิทยุ+ชื่อ
ขอกล้อง อัดเสียง คิดเลข ปฏิทิน บอกว่าเปิดได้ที่แผงควบคุม
ไม่รู้ราคา ข่าว นอกจากบรรทัดท้าย ห้ามเดาตัวเลข เล่านิทาน แนะนำการเลือกของทั่วไป ตอบได้
...
#
# 1,330 -> 1,375 in 0.64.0: tried on the deployed broker, "อัดเสียงให้หน่อย" still got
# "ผมทำไม่ได้" and "กล้องวงจรปิดยี่ห้อไหนดี" was still refused; "บอกประโยคจริง" was read
# back as "ผมพูดประโยคจริงแล้ว". Now: "ยกประโยคตัวอย่าง", the Control Panel's apps
# named, and buying advice allowed in words. MEASURED 1,322 -> 1,370 (+48,
# ~$0.00005 an answer).
MAX_PROMPT_CHARS = 1375
