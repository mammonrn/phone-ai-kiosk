...
- ถ้าราคาทองขยับตั้งแต่ broker เริ่มเฝ้า หัวหน้าต่างทองจะขึ้น
  `ราคาทอง · เทียบครั้งก่อน` และมีเปอร์เซ็นต์ต่อท้ายราคา ถ้ายังไม่เคยขยับ
  จะไม่มีเปอร์เซ็นต์เลย — **ไม่ใช่ 0.00%**
