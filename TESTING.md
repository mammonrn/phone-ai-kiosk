...
4. ถอดปลั๊ก Light2 (หรือตอนที่ออฟไลน์อยู่) แล้วพูด "เปิดไฟห้องนอน" → จาร์วิสบอกว่า **ออฟไลน์** ไม่พูดว่าเปิดแล้ว
   บนการ์ด Light2 ขึ้น "ออฟไลน์" และไม่มีปุ่ม
...
7. กดปุ่ม "สั่งเปิด" / "สั่งปิด" บนการ์ด → ปุ่มเป็น "กำลังสั่ง…" แล้วบรรทัดใต้แถวบอกผลจริง แถวเปลี่ยนตามผลเท่านั้น
8. `$B ewelink-control off` → พูดสั่งไฟ จาร์วิสตอบ "ตอนนี้ปิดการสั่งไฟไว้ครับ" ปุ่มบนการ์ดหายในรอบถัดไป → `$B ewelink-control on`
